...
- For user-uploaded images, the tool input should use `user_image_id`.
- This assistant is typically used as fallback after `sim_search` fails to find similar results or when the user explicitly asks for OCR/object detection.
